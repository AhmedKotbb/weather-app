 ...
 * @param {string} eventType Event type e.. : 'click'
...
export const updateWeather = function (lat, lon) {
    ...
    fetchData(url.currentWeather(lat, lon), function (currentWeather) {
        ...
        <ul class="meta-list">
            <li class="meta-item">
                ...
                <p class="title-3 meta-text">
                    ${module.formatDate(dateUnix, timezone)}
                </p>
            </li>
            <li class="meta-item">
                <span class="m-icon">location_on</span>
        ...
        fetchData(url.airPollution(lat, lon), function (airPollution) {
            ...
            <div class="highlight-list">
                <div class="card card-sm highlight-card one">
                    ...
                    <span class="badge aqi-${aqi} label-${aqi}" title="${module.messages[aqi].message}">
                        ${module.messages[aqi].level}
                    </span>
                </div>
                    ...
                    <div class="card-list">
                        <div class="card-item">66
                            ...
                            <div>
                                ...
                                <p class="title-1">
                                    ${module.formatTime(sunriseUnixUTC, timezone)}
                                </p>
                            </div>
                        </div>
                        <div class="card-item">
                            ...
                            <div>
                                ...
                                <p class="title-1">
                                    ${module.formatTime(sunsetUnixUTC, timezone)}
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        fetchData(url.forecast(lat, lon), function (forecast) {
            ...
            for (const [index, data] of forecastList.entries()) {
                ...
                tempLi.innerHTML = `
                    <div class="card card-sm slider-card">
                        <p class="body-3">
                            ${module.formatHours(dateTimeUnix, timezone)}
                        </p>
                ...
                windLi.innerHTML = `
                    <div class="card card-sm slider-card">
                        ...
                        <img src="./assets/images/weather_icons/direction.png" width="48" height="48" alt=""
                            class="weather-icon" style="transform: rotate(${windDirection - 180}deg)">
                        <p class="body-3">
                            ${module.mpsTokmh(windSpeed).toPrecision(3)} km/h
                        </p>
                    </div>
                `;
            ...
            forecastSection.innerHTML = `
            <h2 class="title-2" id="forecast-lable">
                5 Days Forecast
            </h2>
            ...
            for (let i = 7; i < forecastList.length; i++) {
                ...
                <p class="label-1">
                    ${date.getDate()} ${module.months[date.getUTCMonth()]}
                </p>
                <p class="label-1">
                    ${module.weekDays[date.getUTCDay()]}
                </p>
                `;
